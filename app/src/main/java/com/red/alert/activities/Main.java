...
public class Main extends AppCompatActivity {
    ...
    void initializeUI() {
        ...
        // Use Material's built-in active indicator styling and only override color.
        mBottomNav.setItemActiveIndicatorColor(
                ColorStateList.valueOf(ContextCompat.getColor(this, R.color.bottom_nav_active_indicator)));
